...
public class ProjectReport extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {

    public final String TAG = "ProjectReport";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        estCost = getIntent().getStringExtra("COST");
        endDate = getIntent().getStringExtra("END");
        currentMS = getIntent().getStringExtra("MILESTONE");
            ...
            public void onClick(View view) {
                if (Build.VERSION.SDK_INT >= 23) {
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.requestPermissions(ProjectReport.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
                    }
                }
